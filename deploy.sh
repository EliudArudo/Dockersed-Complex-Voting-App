...
docker push eliudarudo/complex-voting-app-nginx:latest &&  docker push eliudarudo/complex-voting-app-nginx:$SHA
docker push eliudarudo/complex-voting-app-voter:latest &&  docker push eliudarudo/complex-voting-app-voter:$SHA
docker push eliudarudo/complex-voting-app-admin:latest &&  docker push eliudarudo/complex-voting-app-admin:$SHA
docker push eliudarudo/complex-voting-app-results:latest &&  docker push eliudarudo/complex-voting-app-results:$SHA
docker push eliudarudo/complex-voting-app-ws-server:latest &&  docker push eliudarudo/complex-voting-app-ws-server:$SHA
docker push eliudarudo/complex-voting-app-manager:latest &&  docker push eliudarudo/complex-voting-app-manager:$SHA
docker push eliudarudo/complex-voting-app-worker:latest &&  docker push eliudarudo/complex-voting-app-worker:$SHA
